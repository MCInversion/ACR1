...
h2pred <- Holt(x, alpha=alpha, beta=optim_beta, lead = h, damped=T, plot=F)$pred
plot(x, type="l", xlim=c(nt - h, nt + h), main=paste("Damped 2-parametric ",h,"-step prediction", sep=""), xlab="day", ylab="[°C]")
mtext(paste("alpha = ",alpha, ", beta = ", optim_beta ,sep=""))
  ...
  legend("bottomleft", legend=c(paste("prediction (", ne,"-step)", sep=""), "data"),
         col=c("blue2","red"), lty=c(1, NA), lwd=2 , cex=0.8, pch=c(NA, 20))
```
