...
plot(x=seq(from = 0.001, to = 0.999, by = 0.001), y=models.ets[,4], xlab="alpha", ylab="BIC", main="BIC of simple ES models", pch=20, type="b", col="blue4", ylim=c(1700, 2100))
...
```{r etsPredict, fig.width=12, fig.height=5}
plot(fc_ets.fc)
...
require(aTSA)
h <- 40
plot(x, type="l", xlim=c(nt - h, nt + h), ylim=c(-7,6))
lines(x=(nt + 1):(nt + h), y=Holt(x, lead=h, plot=F, damped=T, phi=0.92)$pred, col="blue2")
