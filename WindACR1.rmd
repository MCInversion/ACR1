...
We observe that there are no significant differences between models. Perhaps the 6th model seems to have the most significantly different predictive abilities from 3rd and 5th model. Significant differences appear only as we increase the dimension of the `DieboldMarianoMatrix` to 23 (all models). With ARIMA and some ARFIMA models having significantly better predictive abilities:
